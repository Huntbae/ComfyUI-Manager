...
- 현재 원고는 30편(`articles/`) — **검색 수요 기반 v5**. 구성과 측정 결과는 `SERIES.md` 참고.
  01~10 체험·나들이 / 11~16 전동카트 / 17~20 면허·법규 / 21~25 운영 / 26~30 교육 도입.
- **17~20편(면허·법규)은 법적 요건을 단정하지 않는다.** 제품 분류는 자사 표기대로 쓰되
  면허·등록·도로주행 가능 여부는 관할 기관 확인을 함께 안내한다. 이 원칙을 바꾸지 말 것.
